...
fn main() {
    ...
    loop {
        ...
        let mut thrust= if next_checkpoint_angle > 100 || next_checkpoint_angle < -100{
            "0"
        } else if x - opponent_x < 200 && x - opponent_x > -200 && y - opponent_y < 200 && y - opponent_y > -200 {
            "SHIELD"
        } else if next_checkpoint_dist < 2000 {
            "70"
        } else if next_checkpoint_angle < 5 && next_checkpoint_angle > -5 && next_checkpoint_dist > 4000 {
            "BOOST"
        } else {
            "100"
        };
